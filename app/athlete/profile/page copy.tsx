        ...
        <form onSubmit={handleSave}>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-6">
            <h2 className="text-xl font-bold mb-6 text-gray-900">Informations personnelles</h2>
              ...
              <div>
                <label className="block text-lg font-semibold text-gray-800 mb-3">Prénom</label>
                <input
                  type="text"
                  value={profile?.full_name || ''}
                  onChange={(e) => setProfile(prev => ({ ...prev, full_name: e.target.value }))}
                  className="w-full max-w-sm p-4 border border-gray-300 rounded-lg text-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full max-w-xs p-4 border border-gray-300 rounded-lg text-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
          </div>

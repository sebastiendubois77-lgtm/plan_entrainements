...
export default function AthleteDashboard() {
  ...
  return (
    <>
      ...
      {/* Planning */}
      <div>
        <h2 className="text-3xl font-extrabold mb-6">Mon planning d'entraînement</h2>
        ...
        {allWeeks.map((weekStart, weekIdx) => {
          ...
          return (
            <div key={weekIdx} className="mb-6">
              <h3 className={`flex items-center justify-between font-semibold mb-3 px-4 py-3 rounded-lg ${isPast ? 'bg-gray-100' : 'bg-white'}`}>
